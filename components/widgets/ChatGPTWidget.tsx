  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hello! I'm here to answer questions about Atishay Jain's professional background, projects, and experience. What would you like to know?",
      timestamp: Date.now(),
    },
  ])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const assistantMessage: Message = {
        role: "assistant",
        content:
          data.response || "I'm not sure how to respond to that. Could you ask about Atishay's projects or experience?",
        timestamp: Date.now(),
      ...
      <CardContent className="p-6 h-full flex flex-col">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground font-mono">Ask about Atishay</p>
          </div>
        </motion.div>
        ...
        >
          <Input
            ref={inputRef}
            type="text"
            placeholder="Ask about Atishay's experience..."
            value={input}
