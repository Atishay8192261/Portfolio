...
export function Footer({ isDark }: FooterProps) {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/atishay8192261", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/atishayjain19", label: "LinkedIn" },
    { icon: Mail, href: "mailto:atishayjain@atie.dev", label: "Email" },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span>© {currentYear} atie.dev</span>
